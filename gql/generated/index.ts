...
export type CurrentUser = UserInterface & {
  ...
  eligibleForTrialReclaim?: Maybe<EligibleForTrialReclaimKind>;
...
export type CurrentUserEligibleForTrialReclaimArgs = {
  promotionName: UserDecisionKind;
};
...
export enum EligibleForTrialReclaimKind {
  Available = 'available',
  Declined = 'declined'
}
...
export type Mutation = {
  ...
  reclaimTrial?: Maybe<ReclaimTrialPayload>;
...
export type MutationReclaimTrialArgs = {
  code: Scalars['String'];
...
/** Autogenerated return type of ReclaimTrial */
export type ReclaimTrialPayload = {
  __typename?: 'ReclaimTrialPayload';
  errors?: Maybe<Scalars['String']>;
  success: Scalars['Boolean'];
};
...
export type UserEligibleForTrialReclaimArgs = {
  promotionName: UserDecisionKind;
};
...
export type UserInterfaceEligibleForTrialReclaimArgs = {
  promotionName: UserDecisionKind;
};
...
export type CurrentUserQuery = { __typename?: 'Query', currentUser?: { __typename?: 'CurrentUser', accessToken?: string | null, accessUntil?: string | null, id: string, email?: string | null, firstName?: string | null, assets?: { __typename?: 'Assets', avatar?: string | null } | null, favorites?: { __typename?: 'Favorites', videos: Array<string | null> } | null } | null };
