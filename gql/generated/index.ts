...
export type AvailableSubscriptionPlan = {
  ...
  /** Kind may be one of global, extra_global, subscription_discount_code, subscription_full_access_code, trial_campaign_code, one_time_code, trial_referral_code, trial_reclaim, upsell */
  codeType?: Maybe<Code>;
...
export type Order = AddPayment | GenericProgramPayment | LiveEventPayment | SubscriptionPayment | WellnessPackagePayment;
...
export type ProgramElement = ProgramDocument | ProgramLiveEvent | ProgramPartElement | ProgramSurveyElement | ProgramVideo;
...
export type SearchResult = SearchBlogPost | SearchBundle | SearchEvent | SearchGenericProgram | SearchInstructor | SearchLandingPage | SearchLiveEvent | SearchPlaylist | SearchVideo;
...
export type WellnessPackagable = GenericProgram | LiveEvent | Promotion | WellnessAccess;
